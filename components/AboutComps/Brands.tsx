  ...
  return (
    <div className="w-full h-[300px] relative rounded-md overflow-hidden">
      <BackgroundGradientAnimation>
        ...
        <div
          className="absolute inset-0 z-50 flex flex-col justify-center items-center px-4 py-6 text-white text-center 
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 items-center mb-6">
            <Badge
              variant="outline"
              className="text-md sm:text-base text-white/70 font-semibold backdrop-blur-md px-3 py-1 rounded-md"
            >
              Brands
            </Badge>
